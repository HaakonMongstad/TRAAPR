...
eval_env = GameEnvironment.GameEnv(agent_1=agent_1,agent_2=agent_2)

train_env = tf_py_environment.TFPyEnvironment(eval_env)
trian_env2 = tf_py_environment.TFPyEnvironment(eval_env)
...
def compute_avg_return(environment, num_episodes=10):
  ...
  for _ in range(num_episodes):
    ...
    while not time_step.is_last():
      action_step = environment.getAction()
...
print(compute_avg_return(train_env, 100))
